...
|---|---|---|---|---|---|---|---|---|---|---|
| R01 | Retail price adjustment | 1 | implemented_live_unverified (R01 v1 ACTIVE, D186, 71f1d2a; local verification only — live provider/deploy verification pending) | legacy per-purchase policy snapshot tier; two-decimal currencies only (D160); vetted price checks only | docs/rules/R01-retail-price-adjustment.md v1 (spec M09/b/c) + code pack sha256 c0ea84d5… (M18b) | assisted (auto-opens a claim; every outbound needs approval) | Board / Purchase / Watching | r01_price_adjustment_v1 + priceWatch dual-mode | R01.json 36 fixtures; 22-scenario parity; M18/M18b | current page is not the purchase-time policy (assumption A-T1/A-T2); R01 v2 merchant tier researched only; non-two-decimal currencies unsupported |
| R02 | Airline cancellation / significant change | 1 | not_implemented (code pack v1 on main 3b31c40, registered, NOT active; M27 code review changes_required, D228/D234; fixes M22b + errata in progress) | – | 14 CFR 260 + 399.80(l) captured (docs/rules/R02-airline-refund.md, v1 researched) | – | – | – | fixtures/R02.json (12) | 7 significance criteria; merchant-of-record path; renumbered-only → manual_review until 2027-07-07; DOT page timer wording conflict disclosed |
| R03 | Credit-card billing error (FCBA) | 1 | not_implemented (code pack v1 written, 19/19 fixtures, held locally until M20; M27 review pending) | – | 15 USC 1666 + 12 CFR 1026.13 + Supp. I captured (R03 spec, v1 researched) | – | – | – | fixtures/R03.json (12) | notice RECEIVED ≤ 60 days after first-statement transmittal; email only if the issuer designates it; no merchant-first gate |
| R04 | Delayed / lost / damaged baggage | 1 | not_implemented (code pack v1 on main 3d5cb7f, registered, NOT active; M27 changes_required, D228/D234; fixes M22b + errata) | – | 14 CFR 254 + 260 + 49 USC 42305 captured (R04 spec, v1 researched) | – | – | – | fixtures/R04.json (12) | $4,700 is the minimum carrier limit (never an estimate); bag-fee refund >12h/15h/30h + mishandled-bag report; carrier claim deadlines not captured; international expenses unsupported |
| R05 | Late / missing online order (MITOR) | 1 | not_implemented (code pack v1 on main 35086f8, registered, NOT active; M27 changes_required, D228/D234; fixes M21b + errata) | – | 16 CFR 435 captured (R05 spec, v1 researched) | – | – | – | fixtures/R05.json (12) | covers SHIPMENT not delivery; 30 days default / 50 with credit application; prompt refund 7 working days; silence = consent only for first ≤30-day delay |
