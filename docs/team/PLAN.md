...
| T20 | 3 | sonnet-tester | T08, T14, T17, T19 | yes | P10 browser acceptance suite (Playwright) against a disposable Convex dev deployment with controlled fixtures and mocked providers, separated from provider smoke tests; accessibility checks; desktop a | e2e/auth.spec.ts, e2e/watches.spec.ts, e2e/purchases.spec.ts, e2e/claims.spec.ts, e2e/resilience.spec.ts, e2e/isolation.spec.ts… | T20a verified (496a916; live seed on adorable-lion-138) · T20 e2e in_progress |
