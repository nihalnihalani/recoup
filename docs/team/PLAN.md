...
| T25 | 5 | sonnet-verifier | T24 | yes | Phase 5 release preparation: reproducible release manifest for the exact release candidate, environment checklist, backup/restore proof on the disposable deployment, deploy order, rollback/restore ins | docs/ops/RELEASE.md, docs/reviews/release-candidate.md, docs/team/HANDOFF.md | verified for rc-2026-09-21 = 3f5f739 (5698f0e, eac1075): gates in worktree, static upload to dev + smoke 6/7 (F-T25-1 false positive), export 70,690 B → import --replace-all 670 docs, ops:backlog/smoke identical before/after; to be re-issued as rc-2026-09-21.2 after T18.6 |
