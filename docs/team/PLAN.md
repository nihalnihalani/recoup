...
| T13 | Hardening: T08.1 (D43/D45 policies), crons retryFailed, then tester | sonnet-integrations, sonnet-backend, sonnet-tester | T10,T11 | in_progress | invariant checklist; adversarial fixtures |
