...
| T23 | 4 | sonnet-verifier | T09, T15, T20, T21, T22 | yes | Phase 4 verification: clean isolated install and all gates, browser suite run against the disposable deployment, scheduler scenario (manual cron invocations), authorized controlled live scenarios, mea | docs/reviews/phase4-verification.md, docs/reviews/read-budgets.md | in_progress (wave 11) |
