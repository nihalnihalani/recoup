...
| T23 | 4 | sonnet-verifier | T09, T15, T20, T21, T22 | yes | Phase 4 verification: clean isolated install and all gates, browser suite run against the disposable deployment, scheduler scenario (manual cron invocations), authorized controlled live scenarios, mea | docs/reviews/phase4-verification.md, docs/reviews/read-budgets.md | verified (ba15aaf @ 529f545; 8/8 gates; scheduler scenario clean; browser suite passes at its designed workers:1; live scenarios BLOCKED per D83; F-T23-3 → T18.5) |
...
| T25 | 5 | sonnet-verifier | T24 | yes | Phase 5 release preparation: reproducible release manifest for the exact release candidate, environment checklist, backup/restore proof on the disposable deployment, deploy order, rollback/restore ins | docs/ops/RELEASE.md, docs/reviews/release-candidate.md, docs/team/HANDOFF.md | verified: rc-2026-09-21 = 3f5f739 (5698f0e, eac1075) and rc-2026-09-21.2 = 357dc37 (eaeb928; lead re-verified tag, code-tip equality, smoke 7/7 live); export/import proof on the disposable deployment; production deploy not authorized |
...
**Owner:** sonnet-backend · **Status:** done (8 commits through 4c3c71e; B1–B6, LOWs, F-T23-3/1b, F-AUD-2; lead gates: 65 files 1321+1, typecheck/lint/patch/codegen clean; awaiting Opus checkpoint 6d) · **Files:** convex/account.ts (+test), policies.ts, profiles.ts, priceWatch.ts, drafts.ts (+tests), ops.ts (+test), mailPurge.ts (+test), patches/@agentmail+convex+0.1.0.patch, docs/ops/RUNBOOK.md, convex/auth.ts, convex/notify.test.ts, schema.ts.
...
| M13 | opus-ingestion-integrations-engineer | in_progress (M12-independent parts first; prepareSend after M12) |
