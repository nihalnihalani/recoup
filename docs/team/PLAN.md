...
| T15 | 2 | sonnet-tester | T12, T13, T14 | no | Cross-module regression tests for Phase 2 slices in tester-owned files: freshness across watches/offers/insights/tracking, market recovery end-to-end from watch check to dashboard, dashboard accountin | convex/freshness.test.ts, convex/dashboard.test.ts, convex/marketFlow.test.ts, docs/reviews/read-budgets.md | in_progress (wave 9, sonnet-tester-2) |
...
| T18 | 3 | sonnet-backend | T16 | yes | P09 backend: authenticated paged data export, explicit account-deletion flow with confirmation, session revocation, tombstone, resumable bounded purge including the AgentMail inbox, bounded provider-f | convex/account.ts, convex/account.test.ts, convex/lib/accountState.ts | in_progress (wave 9) |
