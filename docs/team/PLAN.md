...
| T10 | 2 | sonnet-integrations | T01 | no | P03 recoverable market history: explicit state machine, transactional claim before paid lookup, capped retry/backoff, refresh policy, migration of old stamps, archive/bought guards, fixed user-facing  | convex/market.ts, convex/market.test.ts | in_progress |
