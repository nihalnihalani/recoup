...
| T13 | 2 | sonnet-integrations | T10 | no | Offers freshness (raw timestamps instead of nulled leases), P04 leftovers in market/offers ingestion (own-store exclusion by registrable host, availability in stores, per-watch offer cap in recordSnap | convex/offers.ts, convex/offers.test.ts, convex/lib/offerMatch.ts, convex/lib/offerMatch.test.ts, convex/market.ts, convex/market.test.ts | in_progress |
