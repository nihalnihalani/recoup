...
export function SettingsIcon(props: IconProps) {
  return (
    <Glyph {...props}>
      ...
      <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.820l.060.060a2 2 0 1 1-2.830 2.830l-.060-.060a1.65 1.65 0 0 0-1.820-.33 1.65 1.65 0 0 0-1 1.510V21a2 2 0 0 1-4 0v-.090a1.65 1.65 0 0 0-1.070-1.510 1.65 1.65 0 0 0-1.820.33l-.060.060a2 2 0 1 1-2.830-2.830l.060-.060a1.65 1.65 0 0 0 .33-1.820 1.65 1.65 0 0 0-1.510-1H3a2 2 0 0 1 0-4h.090a1.65 1.65 0 0 0 1.510-1.070 1.65 1.65 0 0 0-.33-1.820l-.060-.060a2 2 0 1 1 2.830-2.830l.060.060a1.65 1.65 0 0 0 1.820.33H9a1.65 1.65 0 0 0 1-1.510V3a2 2 0 0 1 4 0v.090a1.65 1.65 0 0 0 1 1.510 1.65 1.65 0 0 0 1.820-.33l.060-.060a2 2 0 1 1 2.830 2.830l-.060.060a1.65 1.65 0 0 0-.33 1.820V9a1.65 1.65 0 0 0 1.510 1H21a2 2 0 0 1 0 4h-.090a1.65 1.65 0 0 0-1.510 1z" />
    </Glyph>
  );
}
