...
// Scenario titles live in a tiny module of their own so landing-page copy can use them without this module's
// fact-catalogue import (`lib/scenarioTitles.ts`); `model.test.ts` still pins them to `coverage.ts`.
export { SCENARIO_TITLES } from "../../lib/scenarioTitles";
